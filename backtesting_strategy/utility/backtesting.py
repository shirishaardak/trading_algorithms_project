...
class Backtest:
     ...
     def trade_transaction(self, strategiesName):
         ...
         self.backtesting.to_csv(r'D:/trading_algorithms_project/backtesting_strategy/report_data/trade_transaction_' + strategiesName + '.CSV')
     ...
     def Backtest_report(self, df, investment, strategiesName, timeframe):
         ...
         backtest_returns.to_csv(r'D:/trading_algorithms_project/backtesting_strategy/report_data/Backtest_report_' + strategiesName + '.CSV')
