...
class Fyers:
    ...
    def get_data(self, data):
        ...
        data.to_csv(r'D:/trading_algorithms_project/paper_trending_strategy/stock_data/live.csv', index=True, header=True)

        columns = ['Date', 'open', 'high', 'low', 'close', 'v']
        data = pd.read_csv('D:/trading_algorithms_project/paper_trending_strategy/stock_data/live.csv', header = None, names = columns)
